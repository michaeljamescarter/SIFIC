...
Multi-omic factor analysis (MOFA) was undertaken using MOFA2 available on Bioconductor here: https://www.bioconductor.org/packages/release/bioc/html/MOFA2.html. Details of this are on the subsidiary page (see MOFA).
